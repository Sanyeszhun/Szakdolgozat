...
<body>
	...
	<div id="home" class="banner a-banner">
		...
		<div class="container">
			<div class="header">
				<div class="head-logo">
					<a href="index.php"><img src="images/logo.svg" id="logokep" alt="" /></a>
				</div>
				<div class="top-nav">
					<span class="menu"><img src="images/menu.png" alt=""></span>
					<ul class="nav1">
                    <li class="hvr-sweep-to-bottom active"><a href="index.php">Kezdőlap<i><img src="images/nav-but1.png" alt=""/></i></a></li>
